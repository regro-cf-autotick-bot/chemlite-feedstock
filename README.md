...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chemlite-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14059&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/chemlite-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `chemlite` can be installed with:

```
conda install chemlite
```

It is possible to list all of the versions of `chemlite` available on your platform with:
